...
export default function TelegramPopup() {
  ...
  return (
    <div
      className={`transition-opacity duration-350 ${closing ? "opacity-0" : "opacity-100"}`}
      style={{
        position: "fixed",
        inset: 0,
        zIndex: 99999,
      ...
      onClick={dismiss}
    >
      {/* sm: center vertically */}
      <style>{`@media (min-width:640px){.tg-popup-center{align-items:center!important}}`}</style>
      ...
      >
        ...
        >
          ...
          {/* Top banner */}
          <div
            className="relative px-6 pt-6 pb-4 text-center overflow-hidden"
